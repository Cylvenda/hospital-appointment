...
import { LayoutBottomIcon, RoboticIcon, Settings05Icon, DashboardCircleIcon, Doctor01Icon, UserAccountIcon } from "@hugeicons/core-free-icons"
...
const navMain = [
     ...
     {
          title: "Appointments",
          url: "/receptionist-dashboard/appointments",
          icon: (
