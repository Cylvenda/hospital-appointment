    ...
    return (
      <div className="w-full h-[400px] flex items-center justify-center">
         <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm font-bold text-muted-foreground animate-pulse">{t("doctorAppointmentLists.syncingAssessment")}</p>
         </div>
      </div>
    )
  }
  ...
  return (
    <div className="w-full space-y-10 max-w-8xl p-4 md:p-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black tracking-tight italic">{t("doctorAppointmentLists.waitingTitle")}</h1>
          <p className="text-muted-foreground text-lg mt-1 font-medium">
            {t("doctorAppointmentLists.waitingDescription")}
          </p>
        </div>
      ...
      <AnimatePresence mode="popLayout">
           {acceptedAppointments.length === 0 ? (
             ...
             >
               ...
               <div className="space-y-1">
                    <p className="text-2xl font-black text-foreground">{t("doctorAppointmentLists.nothingToReview")}</p>
                    <p className="text-muted-foreground max-w-xs mx-auto font-medium">
                      {t("doctorAppointmentLists.nothingToReviewDescription")}
                    </p>
               </div>
             </motion.div>
           ) : (
